# Here will be the RSS sources from which we will extract the XML.
# The prompts will also be stored here.

# Here will be stored the sources for news from Brasil.
# If you are from another country, you can add sources from where you live.
RSS_FEED = [
